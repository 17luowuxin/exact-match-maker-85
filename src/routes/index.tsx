...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "洛无辛智能科技工作室 | 玩转 AI，创造无限可能" },
      {
        name: "description",
        content:
          "洛无辛智能科技工作室数字创意实验室：AI 绘画、广告海报、人设角色卡、IP 立绘、AI 漫剧、AI 歌曲与互动应用。",
      },
      { property: "og:title", content: "洛无辛智能科技工作室 | 玩转 AI，创造无限可能" },
      {
    ...
    <>
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 pb-20 md:grid-cols-2 md:gap-6 md:px-8 md:pb-32">
          <div className="animate-fade-up">
            ...
            <p className="mt-6 max-w-md text-base text-muted-foreground md:text-lg">
              在蓝紫色的宇宙里，洛无辛智能科技工作室是一个由 AI 驱动的创意据点 ——
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 md:px-8 md:py-24">
        <SectionHeading
          eyebrow="EXPLORE"
          title="六大创作宇宙入口"
          subtitle="从一张海报到一个 IP 世界，洛无辛智能科技工作室提供完整的 AI 创意叙事链条。"
        />
          ...
          <div className="relative grid gap-10 md:grid-cols-[1fr_auto] md:items-end">
            <div>
              <SectionHeading
                eyebrow="ABOUT"
                title="关于洛无辛智能科技工作室"
                subtitle="我们相信 AI 不只是工具，而是新的创作伙伴。洛无辛智能科技工作室是一个把模型、IP 与叙事编织在一起的工作室 —— 在这里，每个角色、每段剧情、每一帧画面，都是一次实验。"
              />
            </div>
            <Link to="/contact">
              <GradientButton size="lg">
