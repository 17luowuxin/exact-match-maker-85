...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "洛洛小工坊 | 玩转 AI，创造无限可能" },
      {
        name: "description",
        content:
          "洛洛小工坊数字创意实验室：AI 绘画、广告海报、人设角色卡、IP 立绘、AI 漫剧、AI 歌曲与互动应用。",
      },
    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 md:px-8 md:py-24">
        <SectionHeading
          eyebrow="EXPLORE"
          title="六大创作宇宙入口"
          subtitle="从一张海报到一个 IP 世界，洛洛小工坊提供完整的 AI 创意叙事链条。"
        />
          ...
          <div className="relative grid gap-10 md:grid-cols-[1fr_auto] md:items-end">
            <div>
              <SectionHeading
                eyebrow="ABOUT"
                title="关于洛洛小工坊"
                subtitle="我们相信 AI 不只是工具，而是新的创作伙伴。洛洛小工坊是一个把模型、IP 与叙事编织在一起的工作室 —— 在这里，每个角色、每段剧情、每一帧画面，都是一次实验。"
              />
            </div>
            <Link to="/contact">
              <GradientButton size="lg">
